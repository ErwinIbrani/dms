...
class Smartgrid {
    ...
    public function render_grid()
    {
        ...
        if($this->_dataset && count($this->_dataset) > 0)
        {
            ...
            $html .= '<table id="sg-table" class="table" cellspacing="0" width="100%">';
...
//        }        
        ...
        $paging_html .= '<div class="float-left">Showing '.($this->_page_row_start + 1).' to '.($this->_page_row_start + $this->_page_row_count).' of '.$this->_total_rows.'</div>';
         
        $paging_html .= '<div class="float-right" role="group">';
        $paging_html .= '<button type="'.$prev_button_type.'" name="'.$this->_config_grid_name.'page" value="1" class="btn btn-default btn-sm '.$css_btn_prev.'" title="Go to first page"><i class="fa fa-fast-backward"></i></button>';
        $paging_html .= '<button type="'.$prev_button_type.'" name="'.$this->_config_grid_name.'page" value="'.$previous_page_number.'" class="btn btn-default btn-sm '.$css_btn_prev.'" title="Go to previous page"><i class="fas fa-backward"></i></button>';
        $paging_html .= '<button type="button" class="btn btn-default btn-sm text-muted">Page '.$this->_page_number.' of '.$this->_total_page.'</button>';
        
        $paging_html .= '<button type="'.$next_button_type.'" name="'.$this->_config_grid_name.'page" value="'.$next_page_number.'" class="btn btn-default btn-sm '.$css_btn_next.'" title="Go to next page"><i class="fa fa-forward"></i></button>';
        $paging_html .= '<button type="'.$next_button_type.'" name="'.$this->_config_grid_name.'page" value="'.$this->_total_page.'" class="btn btn-default btn-sm '.$css_btn_next.'" title="Go to last page"><i class="fa fa-fast-forward"></i></button>';
        $paging_html .= '</div>';
        $paging_html .= '</form>';
        return $paging_html;
    }
    ...
    {
        return $this->str_replace_first("SELECT", "SELECT", $sql);
    }
