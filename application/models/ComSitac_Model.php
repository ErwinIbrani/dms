...
class ComSitac_Model extends CI_Model
{
    ...
    public function getDataByVendor($rowno,$rowperpage,$search="")
    {
        $this->db->select('project_assigment.id,
                           project.id as project_id,
                           project.wbs_id,
    ...
    public function getrecordCountByVendor($search = '')
    {
        $this->db->select('count(*) as allcount');
        $this->db->from('project_assigment');
        $this->db->join('project','project_assigment.project_id = project.id','inner');
    ...
    public function findByComSitac($project_id)
    {
        return $this->db->get_where($this->table, ['project_id' => $project_id, 'name' => 'COM SITAC']);
    }
