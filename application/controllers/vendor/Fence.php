...
class Fence extends CI_Controller
{
	...
	public function index($project_id)
	{
		...
		return view('vendor.cme.fence.index', array('project' => $project));
	}

	public function addfencingworks($project_id)
	{

	}

	public function addpavementlandscaping($project_id)
	{
