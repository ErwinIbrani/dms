...
class Project extends CI_Controller {
    ...
    public function index() {
        $projects = $this->Project_Model
			...
			project.status, project_assigment.assignment_type, project.sitac_start_date, project.work_status', 'New', 1, false);
    ...
    public function onProcess() {
        $projects = $this->Project_Model
                ->getAllByStatusAndVendor('project.id,project.wbs_id, project.iro_number, project.site_id_ibs, project.site_name, 
			project.status, project_assigment.assignment_type, project.sitac_start_date, project.work_status', 'on process', 1, false);
    ...
    public function done() {
        $projects = $this->Project_Model
                ->getAllByStatusAndVendor('project.id,project.wbs_id, project.iro_number, project.site_id_ibs, project.site_name, 
			project.status, project_assigment.assignment_type, project.sitac_start_date, project.work_status', 'done', 1, false);
