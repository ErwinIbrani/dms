			...
			<div class="page-inner">
				...
				<div class="page-section">
					<div class="invoice-wrapper">
						...
						<div class="invoice-actions">
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: top, left; top: 45px; left: 44px;">
									...
									<a href="{{site_url('uploads/surveysitac/'.$document->path.'')}}" id="download-pdf" class="dropdown-item">Download PDF</a>
								</div>
							</div>
						</div>
						...
						<div>
							<embed src="{{base_url('uploads/surveysitac/'.$document->path.'')}}" type="application/pdf" width="800px" height="2100px" />
						</div>
					</div>
				</div>
		</div>
