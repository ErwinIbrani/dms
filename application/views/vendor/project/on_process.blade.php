				...
				<div class="card card-fluid">
					<div class="card-header">
						<ul class="nav nav-tabs card-header-tabs">
							<li class="nav-item">
								<a href="{{ site_url('/vendor/project/index') }}" class="nav-link">
									New Project
								</a>
							</li>
							<li class="nav-item">
								<a href="{{ site_url('/vendor/project/onProcess') }}" class="nav-link active">
									Running Project
								</a>
							</li>
							<li class="nav-item">
											...
											<td class="text-right">
												<div class="list-group-item-figure">
													...
													@if($project->assignment_type === 'IMB')
															<a href="{{ site_url('/vendor/rfc/imb/' . $project->id) }}" title="View details" class="btn btn-sm btn-icon btn-secondary stop-propagation"><i class="fas fa-ellipsis-h"></i></a>
													@endif
