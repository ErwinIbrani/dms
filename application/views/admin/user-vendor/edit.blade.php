    ...
    <div class="page-inner">
        ...
        <div class="page-section">
            <div id="base-style" class="card">
                ...
                echo form_open('admin/uservendor/update',$data);
                ?>
                <!-- .fieldset -->
                    <fieldset>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="vendor_id" class="custom-select js-example-basic-single" required="">
                                        ...
                                        foreach ($groupvendors as $data) {
                                            ...
                                            echo $model->vendor_id == $data->id ? 'selected': '';
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" autocomplete="off" value="<?= $model->email ?>" required=""/>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" autocomplete="off" value="<?= $model->phone ?>" required=""/>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="region_id" class="custom-select js-example-basic-single region" required="">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="province_id" class="custom-select js-example-basic-single region" required="">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="city_id" class="custom-select js-example-basic-single region" required="">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="tf6" rows="3" name="address" required=""><?= $model->address ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="layer" required="">
                                        <option value="" selected="selected">Layer</option>
                                        <?php
                                        if ($model->level == 'PIC')
                                            echo "<option value='1' selected> PIC </option>";
                                        else echo "<option value='1'> PIC </option>";
                                        ?>
